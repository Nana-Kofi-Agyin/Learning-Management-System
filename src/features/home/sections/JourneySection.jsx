...
function JourneySection({ heroImg }) {
  return (
    <section className="mt-20 grid items-center gap-8 lg:grid-cols-2">
      ...
      <div className="relative rounded-2xl border border-slate-200 bg-white p-5 shadow-lg sm:pb-10">
        ...
        <blockquote className="mt-4 rounded-xl bg-cyan-900 p-4 text-xs font-medium leading-relaxed text-cyan-50 shadow-xl sm:absolute sm:-bottom-5 sm:right-4 sm:mt-0 sm:max-w-[220px]">
